...
#用长度为(10+26+26)的向量来表示一个字符，这有四个向量
def text2vec(text):  
    text_len = len(text)  
    ...
    with tf.Session() as sess:
        ...
        while True:
            ...
            if step % 10 == 0:
                ...
                acc, loss_ = sess.run([accuracy, loss], feed_dict={X: batch_x_test, Y: batch_y_test, keep_prob: 0.8})#Dropout层保留0.8
